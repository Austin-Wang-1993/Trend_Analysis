...
| 文档 | 说明 |
|------|------|
| [**REQUIREMENTS.md**](./REQUIREMENTS.md) | **v3.6** 需求：概念 Tab、原子资金流 |
| [**IMPLEMENTATION_PLAN.md**](./IMPLEMENTATION_PLAN.md) | **v3.6** 方案与 API |
| [**BRANCHING.md**](./BRANCHING.md) | **分支策略、PR 归档、部署只跟 main** |
...
| **v3.5** | 2026-06-15 | 管理页 **区间补数**（起止必填、不跳过已有、≤30 交易日）；**移除强制补数** |
| **v3.6** | 2026-06-18 | 页面 2 **概念 Tab**；原子资金流；分支收敛为 **main** 单线发布 |
