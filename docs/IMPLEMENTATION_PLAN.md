...
<nav>
  ...
  <a href="/stock-list.html">股票清单</a>
  <a href="/signals.html">交易信号</a>
  <a href="/train-track.html">火车轨选股</a>
  <a href="/etf-table.html">ETF 表格</a>
  <a href="/admin.html">管理</a>
</nav>
```

详见 [TRADING_SIGNAL.md](./TRADING_SIGNAL.md)（v4.2 交易信号页）、[TRAIN_TRACK_RPS.md](./TRAIN_TRACK_RPS.md)（v4.3 火车轨选股）。
